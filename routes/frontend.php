...
Route::delete('/table_requestdelete/{id}',[FrontendController::class,'deleteBookingreq'])->name('frontend.deletetbl_request');


// payment
Route::post('/payment/{id}',[PaymentController::class,'checkout']);
