...
<template>
    ...
    <AppLayout title="Booking Request List" pageName="Booking Request List">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span
                                    class="ms-1 text-sm font-medium text-gray-700 md:ms-2 dark:text-gray-400 dark:text-white">In
                                    Touch
                                    List</span>
                            </div>
                        </li>
                                                    ...
                                                    <tr v-for="record in data.data" :key="record"
                                                        ...
                                                        <td class="px-6 py-4">
                                                            ...
                                                            <span v-else-if="record.status == 'pending'"
                                                                class="bg-red-100 text-yellow-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-red-300">{{
                                                                    record.status }}</span>
